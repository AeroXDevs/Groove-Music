    ...
    try {
      ...
      if (songExists) {
        const infoDisplay = new TextDisplayBuilder()
          .setContent(client.t(message.guild.id, "fav.already", { e: client.emoji.info }));
      ...
      const successDisplay = new TextDisplayBuilder()
        .setContent(client.t(message.guild.id, "fav.added", { e: client.emoji.check, title: song.title, uri: song.uri }));
      ...
      const errorDisplay = new TextDisplayBuilder()
        .setContent(client.t(message.guild.id, "fav.saveError", { e: client.emoji.cross }));
